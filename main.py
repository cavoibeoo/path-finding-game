...
class Game():
    def __init__(self):
        ...
        self.score_algorithms = ['bfs', 'dls', 'ucs', 'astar']
        self.no_score_algorithms = ['n_bfs', 'n_dfs', 'n_ucs', 'n_astar']
    ...
    def initial_game(self):
        ...
        text(self.background, "GROUP MEMBER", INTERMEDIARYORANGE, FONTSIZE_COMMANDS_INTIAL + 5, 600, 20)
        text(self.background, "Tran Duc Quang" , INTERMEDIARYORANGE, FONTSIZE_COMMANDS_INTIAL + 5, 600, 60)
        text(self.background, "Tran Binh Phuoc", INTERMEDIARYORANGE, FONTSIZE_COMMANDS_INTIAL + 5, 600, 90)
        text(self.background, "Nguyen Le Giang Ha", INTERMEDIARYORANGE, FONTSIZE_COMMANDS_INTIAL + 5, 600, 120)
        text(self.background, "Lam Nguyen Huy Hoang", INTERMEDIARYORANGE, FONTSIZE_COMMANDS_INTIAL + 5, 600, 150)
    ...
    def render(self):##############################################################################
        ...
        text(self.background, "Tran Duc Quang", WHITE, FONTSIZE_COMMANDS_INTIAL + 5, 610, 60)
        text(self.background, "Tran Binh Phuoc", WHITE, FONTSIZE_COMMANDS_INTIAL + 5, 610, 90)
        text(self.background, "Nguyen Le Giang Ha", WHITE, FONTSIZE_COMMANDS_INTIAL + 5, 610, 120)
        text(self.background, "Lam Nguyen Huy Hoang", WHITE, FONTSIZE_COMMANDS_INTIAL + 5, 610, 150)

        pygame.draw.rect(self.background, DARKGRAY, [600, 180, 300, 5])

        if SCORE_MODE == True:
            text(self.background, "CURRENTLY CONSUMING STEPS", DARKBLUE, FONTSIZE_COMMANDS_INTIAL, 615, 195)
        else: 
            text(self.background, "CURRENTLY NOT CONSUMING STEPS", DARKBLUE, FONTSIZE_COMMANDS_INTIAL, 600, 195)
        
        text(self.background, f"ALGORITHM: {current_algorithm.upper()}", WHITE, FONTSIZE_COMMANDS_INTIAL, 670, 215)
        text(self.background, f"STEPS TAKEN: {self.total}",  DARKBLUE, FONTSIZE_COMMANDS_INTIAL , 675, 235)
        ...
        if SCORE_MODE:
            text(self.background, f"SCORE: {self.player.score}", WHITE, FONTSIZE_COMMANDS_INTIAL, 705, 255)  # Moved and changed font size
        pygame.display.update()
